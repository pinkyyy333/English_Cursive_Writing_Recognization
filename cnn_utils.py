...
class TrainCharDataset(Dataset):
...
def load_train_char_dataset(path: str='train_data/')->Tuple[List, List]:
    images = []
    labels = []
...
def load_test_char_dataset(path: str='test_data/')->List:
    images = []
...
def plot_cnn(train_losses: List, val_losses: List):
