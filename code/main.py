...
from cnn_utils import TrainCharDataset as TrainDataset, TestCharDataset as TestDataset, load_train_char_dataset as load_train_dataset, load_test_char_dataset as load_test_dataset, plot_cnn as plot, check_ans
...
def main():
    ...
    test_accuracy = check_ans("ans.csv", "CNN.csv")
    logger.info(f"Accuracy for testdata is {test_accuracy:.4f}")
    logging.info(f"Accuracy for testdata is {test_accuracy:.4f}")
